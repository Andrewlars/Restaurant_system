...
public class DrinksAndDessert {
    ...
    public DrinksAndDessert(Order[] orders, OrderCount orderCount)  {
        this.orders = orders;
        this.orderCount = orderCount;
    }

    public void displayDrinksAndDessertsMenu() {
        ...
        while (true) {
            ...
            if (choice >= 1 && choice <= MenuData.NUM_DRINKS_AND_DESSERTS_ITEMS) {
                ...
                if (saveOrder == 1) {
                    ...
                    orders[orderCount.count++] = new Order("DrinksAndDesserts", choice - 1, quantity, price);
